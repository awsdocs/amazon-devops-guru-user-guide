# How Amazon DevOps Guru works with IAM<a name="security_iam_service-with-iam"></a>
...
## Identity\-based policies for DevOps Guru<a name="security_iam_service-with-iam-id-based-policies"></a>
...
### Identity\-based policy examples for DevOps Guru<a name="security_iam_service-with-iam-id-based-policies-examples"></a>
...
## Resource\-based policies within DevOps Guru<a name="security_iam_service-with-iam-resource-based-policies"></a>
...
## Policy actions for DevOps Guru<a name="security_iam_service-with-iam-id-based-policies-actions"></a>
...
To see a list of DevOps Guru actions, see [Actions defined by Amazon DevOps Guru](https://docs.aws.amazon.com/service-authorization/latest/reference/list_awskeymanagementservice.html#awskeymanagementservice-actions-as-permissions) in the *Service Authorization Reference*\.
...
## Policy resources for DevOps Guru<a name="security_iam_service-with-iam-id-based-policies-resources"></a>
...
## Policy condition keys for DevOps Guru<a name="security_iam_service-with-iam-id-based-policies-conditionkeys"></a>
...
## Access control lists \(ACLs\) in DevOps Guru<a name="security_iam_service-with-iam-acls"></a>
...
## Attribute\-based access control \(ABAC\) with DevOps Guru<a name="security_iam_service-with-iam-tags"></a>
...
## Using Temporary credentials with DevOps Guru<a name="security_iam_service-with-iam-roles-tempcreds"></a>
...
## Cross\-service principal permissions for DevOps Guru<a name="security_iam_service-with-iam-principal-permissions"></a>
...
## Service roles for DevOps Guru<a name="security_iam_service-with-iam-roles-service"></a>
...
## Service\-linked roles for DevOps Guru<a name="security_iam_service-with-iam-roles-service-linked"></a>
